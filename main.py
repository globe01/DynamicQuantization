...
from quantization_utils import (
    ...
    interval_based_quantize, interval_based_quantize_dequantize, interval_based_quantize_dequantize_2,
...
#
# data = extract_weights_in_chunks(checkpoint_path, target_keys, b1)
#
...
quantized_data_second, hist_data, dynamic_quantized_data = dynamic_quantize_level_reduce_dequantize_2(dequantized_data, data, b2)
...
# 确保 dynamic_quantized_data 是一个 NumPy 数组
dynamic_quantized_data_numpy = dynamic_quantized_data.numpy()

# 指定保存路径
output_file_dynamic_quantized = "output/dynamic_quantized_data.txt"

# 保存数据到文本文件
np.savetxt(output_file_dynamic_quantized, dynamic_quantized_data_numpy, fmt="%.6f", header="Dynamic Quantized Data", comments="")

print(f"Dynamic quantized data saved to {output_file_dynamic_quantized}")
